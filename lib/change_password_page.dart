  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Change Password", style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold)),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("Create a New Password", style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black)),
            const SizedBox(height: 40),
